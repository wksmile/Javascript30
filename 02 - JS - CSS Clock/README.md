...
1. 利用定时器自动更新时间
	...
	```javascript
	 ...
	 不过使用setInterval会存在一些问题，具体setTimeout和setInterval的区别可以看[这里介绍](http://blog.csdn.net/baidu_24024601/article/details/51862488),使用setTimeout模拟setInterval代码如下：
